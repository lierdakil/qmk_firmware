...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[BASE] = LAYOUT_planck_mit(
        ...
        KC_CAPS, KC_SLCK, 84, MO(1), LSFT_T(KC_BSPC), LT(4,KC_ENT), RSFT_T(KC_SPC), MO(2), KC_UP, KC_DOWN, TG(5)
        ),
	[LOWER] = LAYOUT_planck_mit(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(3),         KC_TRNS,       KC_TRNS, KC_TRNS
        ),
